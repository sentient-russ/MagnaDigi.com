...
namespace magnadigi.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<magnadigiUser> _signInManager;
        ...
        public ExternalLoginModel(
            SignInManager<magnadigiUser> signInManager,
            UserManager<magnadigiUser> userManager,
            IUserStore<magnadigiUser> userStore,
        ...
        private magnadigiUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<magnadigiUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(magnadigiUser)}'. " +
                    $"Ensure that '{nameof(magnadigiUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
